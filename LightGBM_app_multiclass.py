...
# Streamlit UI
st.title("Policy Status Prediction App: Multiclass")
...
if predict_btn:
    ...
    predicted_proba.rename(columns={0: 'Active Class', 1: 'Lapsed Class', 2: 'Surrendered Class'},index={0: 'Predicted Probability'},inplace=True)
